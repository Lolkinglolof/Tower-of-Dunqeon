...
public class Movement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (gameObject.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("Dodge"))
        {
            movementVector = MoveSpeed * 1.2f * transform.forward;
        }
